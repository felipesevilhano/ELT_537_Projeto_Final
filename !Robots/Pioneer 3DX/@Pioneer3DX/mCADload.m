...
obj.pCAD.obj{1} = loadawobj('Pioneer3DXAssembly.obj');
obj.pCAD.mtl{1} = loadawmtl('Pioneer3DXAssembly.mtl');
...
vExt = minmax(obj.pCAD.obj{1}.v);
mExt = mean(vExt,2);
for ii = 1:3
    obj.pCAD.obj{1}.v(ii,:) = (obj.pCAD.obj{1}.v(ii,:) - mExt(ii));
end

% Ajustando a orientação e posição iniciais:
obj.pCAD.obj{1}.v = [0 1 0; -1 0 0; 0 0 1]*obj.pCAD.obj{1}.v;

obj.pCAD.obj{1}.v(1,:) = obj.pCAD.obj{1}.v(1,:) - 0.0457*ones(1,length(obj.pCAD.obj{1}.v(1,:)));
% obj.pCAD.obj{1}.v(2,:) = obj.pCAD.obj{1}.v(2,:);% + 0.0125*ones(1,length(obj.pCAD.obj{1}.v(2,:)));
obj.pCAD.obj{1}.v(3,:) = obj.pCAD.obj{1}.v(3,:) - min(obj.pCAD.obj{1}.v(3,:))*ones(1,length(obj.pCAD.obj{1}.v(3,:)));
