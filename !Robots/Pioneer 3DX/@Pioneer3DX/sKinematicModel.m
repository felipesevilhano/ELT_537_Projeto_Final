...
p3dx.pPar.K = [cos(p3dx.pPos.X(6)) -p3dx.pPar.a*sin(p3dx.pPos.X(6)+p3dx.pPar.alpha); ...
               sin(p3dx.pPos.X(6))  p3dx.pPar.a*cos(p3dx.pPos.X(6)+p3dx.pPar.alpha); ...
                         0                                 1                      ];

% first-time derivative of the current position
p3dx.pPos.X([7 8 12]) = p3dx.pPar.K*p3dx.pSC.U(1:2);
p3dx.pPos.dX([1 2 6]) = p3dx.pPos.X([7 8 12]);

% Current position
p3dx.pPos.X([1 2 6]) = p3dx.pPos.X([1 2 6]) + p3dx.pPos.dX([1 2 6])*p3dx.pPar.Ts;
...
% -------------------------------------------------------------------------
% - Modelo Polar (a ser implementado):
% Reference: 
