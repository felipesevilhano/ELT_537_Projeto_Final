function drone = cArDrone_InverseDynamic_wDynamicCompensator(drone,gains)
...
% if (norm(drone.pPos.Xtil) == 0)
%     Xtil = Xd - X;
%     dXtil = dXd - dX;
% else
%     %     Xtil = drone.pPos.Xtil([1:3 6]);
%     %     dXtil = drone.pPos.Xtil([7:9 12]);
% end
...
dUcw = (Ucw - Ucw_ant)/drone.pPar.Ts; %toc(drone.pSC.tcontrole);
